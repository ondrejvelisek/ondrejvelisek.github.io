...
function DiscussLink({ icon, href }: DiscussLinkProps) {
  ...
  return (
    <a
      href={href}
      className="hover:no-underline px-4 py-3 border-solid border rounded border-zinc-700 text-white"
    >
...
export default function Discuss({
  ...
  return (
    <div className="flex gap-2 w-full flex-wrap my-8">
      ...
      <DiscussLink href={bsky} icon={faBluesky} />
      ...
      <DiscussLink href={li} icon={faLinkedin} />
    </div>
  );
}
