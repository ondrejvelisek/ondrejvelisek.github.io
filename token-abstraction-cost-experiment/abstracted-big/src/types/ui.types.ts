...
export type KeypadSectionId = 'functions' | 'numeric';

export type KeypadColumnCount = 4 | 6;

export type KeypadColumnSpan = 1 | 2;

export interface SecondaryKeyBinding {
...
export interface ResolvedKeyBinding {
  ...
  readonly ariaLabel: string;
  readonly description: string;
  /** Keyboard shortcut shown in the corner of the key, if it has one. */
